 ...
 */
public class FetchData extends AsyncTask<Object, Object, ArrayList<com.example.mohamednasser.mal_final_phase.Image>> {
    ...
    private String APPID = "2f49062389b0826b5bde6edb48192945";
    ...
    @Override
    protected ArrayList<com.example.mohamednasser.mal_final_phase.Image> doInBackground(Object... params)
    {
    ...
    public ArrayList<com.example.mohamednasser.mal_final_phase.Image> jsonParsing(String result){
        ArrayList<com.example.mohamednasser.mal_final_phase.Image> finalArrayList = new ArrayList<>(); // this is the array to be passed
        ...
        try {
            ...
            com.example.mohamednasser.mal_final_phase.Image images = null;
            ...
            for(int i =0;i<jsonArray.length();i++) {
                ...
                Log.v("XXXXXXXXXX",id);
                images = new com.example.mohamednasser.mal_final_phase.Image(title,imagePath,overview,vote,year,id);
    ...
    protected void onPostExecute(ArrayList<com.example.mohamednasser.mal_final_phase.Image> images) {
